...
# https://winget.run/pkg/EpicGames/EpicGamesLauncher
init_item "Epic Games" "EpicGames.EpicGamesLauncher"
...
# https://winget.run/pkg/Moonsworth/LunarClient
init_item "Luna Client" "Moonsworth.LunarClient"
...
# https://winget.run/pkg/Microsoft/Sysinternals.Autoruns
init_item "Autoruns" "Microsoft.Sysinternals.Autoruns"
